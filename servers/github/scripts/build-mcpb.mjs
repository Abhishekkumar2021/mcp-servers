#!/usr/bin/env node
/**
 * Build an MCPB bundle (.mcpb) for the github server.
 *
 ...
 * install.
 *
 * Output: servers/github/dist-mcpb/github-<version>.mcpb  (gitignored; attach to a release)
 *
...
const serverRoot = path.resolve(here, ".."); // servers/github
