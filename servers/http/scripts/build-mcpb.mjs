#!/usr/bin/env node
/**
 * Build an MCPB bundle (.mcpb) for the http server.
 *
 ...
 * install.
 *
 * Output: servers/git/dist-mcpb/git-<version>.mcpb  (gitignored; attach to a release)
 *
...
const serverRoot = path.resolve(here, ".."); // servers/http
